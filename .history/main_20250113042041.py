...
if tf_version < "2.0.0":
    raise ImportError(f"This code requires TensorFlow >= 2.0.0, but found {tf_version}")
...
def ioc_detector(doc: Doc, *, patterns: Dict[str, str]) -> Doc:
    """Custom spaCy component for IOC detection."""
    matches = []
...
def main():
    ...
    try:
        ...
        logger.info(f"Successfully processed document. Found {len(results_df)} IOCs.")
