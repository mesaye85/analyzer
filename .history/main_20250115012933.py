...
nltk.download('punkt', download_dir='/workspaces/analyzer/nltk_data')

nltk.data.path.append('/workspaces/analyzer/nltk_data')
...
def split_text_into_chunks(text, max_chunk_size=512):
    ...
    if len(chunks) > 100:  # Arbitrary limit
        raise ValueError("Text is too large to process efficiently.")
